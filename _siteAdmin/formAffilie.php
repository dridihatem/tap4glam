...
<li><a href="index.php?pg=adminAffilie" class="active">Gestion des Affiliés</a> </li>

</ul>

    <div class="page-title"> <a href="index.php?pg=adminAffilie"><i class="icon-custom-left"></i></a>

<h3>Module - <span class="semi-bold">Modifier / Ajouter un affilié</span></h3>
...
<form action="controller/affilie_save.php?op=<?php if($_GET["id"]== 0){echo "1";}else{echo "2";}?>" method="post" enctype="multipart/form-data" name="frm_modules">
